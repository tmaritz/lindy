...
|--:|------|------:|------:|----:|:------:|--------:|---------|-------|
| 1 | [openai/openai-python](https://github.com/openai/openai-python) | **83.0** | 31,503 | 5y | 12 | 161 | hn | 2y+ old; commits almost every month; 161+ contributors; tagged releases |
...
- **[google/googletest](https://github.com/google/googletest)** (C++): GoogleTest - Google Testing and Mocking Framework
...
- **[workweave/router](https://github.com/workweave/router)** (Go): Model router for agentic systems. Routes every prompt to the right model in <50ms. Cut costs 40-70% with just an endpoint change.
